  ...
  return (
    <div className='w-full flex gap-5 h-screen p-20'>
        <div className="w-1/2 h-full flex flex-col justify-between">
            ...
            <h1 className='text-[5vw] font-semibold uppercase leading-none -mb-4 tracking-tighter'>Eye-</h1>
            <h1 className='text-[5vw] font-semibold uppercase leading-none -mb-4 tracking-tighter'>Opening</h1>
            </div>
        ...
        <div className="w-1/2">
        <h1 className='text-[5vw] font-semibold uppercase leading-none -mb-6 tracking-tighter'>Presentaions</h1>
        <div className='underline underline-offset-1 flex '>
            <div className='w-1/2'>
            <p className='py-6 underline underline-offset-1'>S:</p>
            <a href="">Instagram</a> <br />
            <a href=""> Behance</a> <br />
            <a href="">Facebook</a> <br />
            <a href="">Linkedin</a> <br />
      
            <p className='py-5 underline underline-offset-1'>L;</p>
            <a href="">202-1965 W 4th Ave</a> <br />
            <a href=""> Vancouver, Canada</a> <br /><br />
            <a href="">30 Chukarina St</a> <br />
            <a href="">Lviv, Ukraine</a> <br /><br />
            <p>E:</p><br />
            <a href="">hello@ochi.design</a></div>
            <div className='w-1/2 py-40 underline underline-offset-1 me-4'>
            <p>M:</p><br />
            <a href="">Home</a><br />
